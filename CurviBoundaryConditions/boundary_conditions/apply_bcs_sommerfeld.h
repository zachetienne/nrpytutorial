            ...
            for(int which_gz = 0; which_gz < NGHOSTS; which_gz++) {
                for(int pt=0;pt<bcstruct->num_ob_gz_pts[which_gz];pt++) {
                    ...
                    if(abs(FACEX0)==1 || i0+NGHOSTS >= Nxx_plus_2NGHOSTS0 || i0-NGHOSTS <= 0) {
                      ...
                      if(i0+NGHOSTS >= Nxx_plus_2NGHOSTS0) FACE0PARITY = -1;
                      if(i0-NGHOSTS <= 0)                  FACE0PARITY = +1;
                      dfdx = FACE0PARITY*(-3*gfs[IDX4S(which_gf,i0              ,i1,i2)]
                                          +4*gfs[IDX4S(which_gf,i0+1*FACE0PARITY,i1,i2)]
                                          -1*gfs[IDX4S(which_gf,i0+2*FACE0PARITY,i1,i2)])*invdx0*0.5;
                    ...
                    if(abs(FACEX1)==1 || i1+NGHOSTS >= Nxx_plus_2NGHOSTS1 || i1-NGHOSTS <= 0) {
                      ...
                      if(i1+NGHOSTS >= Nxx_plus_2NGHOSTS1) FACE1PARITY = -1;
                      if(i1-NGHOSTS <= 0)                  FACE1PARITY = +1;
                    ...
                    if(abs(FACEX2)==1 || i2+NGHOSTS >= Nxx_plus_2NGHOSTS2 || i2-NGHOSTS <= 0) {
                      ...
                      if(i2+NGHOSTS >= Nxx_plus_2NGHOSTS2) FACE2PARITY = -1;
                      if(i2-NGHOSTS <= 0)                  FACE2PARITY = +1;
                    ...
                    if (radpower > 0) {
                      ...
                      if(abs(FACEX0)==1 || ip0+NGHOSTS >= Nxx_plus_2NGHOSTS0 || ip0-NGHOSTS <= 0) {
                        int8_t FACE0PARITY = FACEX0;
                        if(ip0+NGHOSTS >= Nxx_plus_2NGHOSTS0)  FACE0PARITY = -1;
                        if(ip0-NGHOSTS <= 0)                   FACE0PARITY = +1;
                        dfdx = FACE0PARITY*(-3*gfs[IDX4S(which_gf,ip0              ,ip1,ip2)]
                                            +4*gfs[IDX4S(which_gf,ip0+1*FACE0PARITY,ip1,ip2)]
                                            -1*gfs[IDX4S(which_gf,ip0+2*FACE0PARITY,ip1,ip2)])*invdx0*0.5;
                      ...
                      if(abs(FACEX1)==1 || ip1+NGHOSTS >= Nxx_plus_2NGHOSTS1 || ip1-NGHOSTS <= 0) {
                        int8_t FACE1PARITY = FACEX1;
                        if(ip1+NGHOSTS >= Nxx_plus_2NGHOSTS1) FACE1PARITY = -1;
                        if(ip1-NGHOSTS <= 0)                  FACE1PARITY = +1;
                      ...
                      if(abs(FACEX2)==1 || ip2+NGHOSTS >= Nxx_plus_2NGHOSTS2 || ip2-NGHOSTS <= 0) {
                        int8_t FACE2PARITY = FACEX2;
                        if(ip2+NGHOSTS >= Nxx_plus_2NGHOSTS2) FACE2PARITY = -1;
                        if(ip2-NGHOSTS <= 0)                  FACE2PARITY = +1;
