...
rhs_eval(Nxx,Nxx_plus_2NGHOSTS,dxx, xx, y_n_gfs, k_odd_gfs);
LOOP_ALL_GFS_GPS(i) {
...
rhs_eval(Nxx,Nxx_plus_2NGHOSTS,dxx, xx, k_odd_gfs, k_even_gfs);
LOOP_ALL_GFS_GPS(i) {
...
rhs_eval(Nxx,Nxx_plus_2NGHOSTS,dxx, xx, k_even_gfs, k_odd_gfs);
LOOP_ALL_GFS_GPS(i) {
