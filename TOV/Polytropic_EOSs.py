...
#|-------------------------------------------------------------------------|
#| This file has been generated by the TOV/Polytropic_EOSs.py NRPy+ module |
#|-------------------------------------------------------------------------|
...
#|-------------------------------------------------------------------------|
#|   *Warning*: it is highly recommended not to change this file by hand   |
#.-------------------------------------------------------------------------.
""")
    if EOSname == "single":
...
#.-------------------------------.
#
# Set the number of EOSs, which is one for a single polytrope.
IllinoisGRMHD::neos = 1

# Set K_ppoly_tab0
IllinoisGRMHD::K_ppoly_tab0 = """+str(K_single_polytrope)+"""

# Set Gamma_ppoly_tab_in[0]
IllinoisGRMHD::Gamma_ppoly_tab_in[0] = """+str(Gamma_single_polytrope)+"""
