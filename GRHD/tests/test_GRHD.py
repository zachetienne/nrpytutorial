...
def test_equations():
    ...
    function_and_global_dict = {'generate_everything_for_UnitTesting()': ['h','T4UU','T4UD','sqrtgammaDET','rho_star','tau_tilde','S_tildeD','vU','rho_star_fluxU','tau_tilde_fluxU','S_tilde_fluxUD','s_source_term','g4DDdD','S_tilde_source_termD','u4_ito_3velsU']}
