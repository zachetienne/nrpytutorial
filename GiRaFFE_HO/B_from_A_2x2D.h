{
   ...
   const double AD_ddnD02 = invdx2*((3.0/2.0)*AD0 - 2*AD0_i0_i1_i2m1 + (1.0/2.0)*AD0_i0_i1_i2m2);
   const double AD_ddnD12 = invdx2*((3.0/2.0)*AD1 - 2*AD1_i0_i1_i2m1 + (1.0/2.0)*AD1_i0_i1_i2m2);
   /* 
   ...
   aux_gfs[IDX4(BU0GF, i0, i1, i2)] = AD_dD21*tmp0 - AD_ddnD12*tmp0;
   aux_gfs[IDX4(BU1GF, i0, i1, i2)] = -AD_dD20*tmp0 + AD_ddnD02*tmp0;
