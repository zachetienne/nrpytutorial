{
   ...
   const double AD_dupD10 = invdx0*(-3.0/2.0*AD1 + 2*AD1_i0p1_i1_i2 - 1.0/2.0*AD1_i0p2_i1_i2);
   const double AD_dupD20 = invdx0*(-3.0/2.0*AD2 + 2*AD2_i0p1_i1_i2 - 1.0/2.0*AD2_i0p2_i1_i2);
   /* 
   ...
   aux_gfs[IDX4(BU1GF, i0, i1, i2)] = AD_dD02*tmp0 - AD_dupD20*tmp0;
   aux_gfs[IDX4(BU2GF, i0, i1, i2)] = -AD_dD01*tmp0 + AD_dupD10*tmp0;
}
