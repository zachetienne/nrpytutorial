{
   ...
   const double AD_dD01 = invdx1*(-2.0/3.0*AD0_i0_i1m1_i2 + (1.0/12.0)*AD0_i0_i1m2_i2 + (2.0/3.0)*AD0_i0_i1p1_i2 - 1.0/12.0*AD0_i0_i1p2_i2);
   const double AD_dD02 = invdx2*(-2.0/3.0*AD0_i0_i1_i2m1 + (1.0/12.0)*AD0_i0_i1_i2m2 + (2.0/3.0)*AD0_i0_i1_i2p1 - 1.0/12.0*AD0_i0_i1_i2p2);
   const double AD_dD10 = invdx0*(-2.0/3.0*AD1_i0m1_i1_i2 + (1.0/12.0)*AD1_i0m2_i1_i2 + (2.0/3.0)*AD1_i0p1_i1_i2 - 1.0/12.0*AD1_i0p2_i1_i2);
   const double AD_dD12 = invdx2*(-2.0/3.0*AD1_i0_i1_i2m1 + (1.0/12.0)*AD1_i0_i1_i2m2 + (2.0/3.0)*AD1_i0_i1_i2p1 - 1.0/12.0*AD1_i0_i1_i2p2);
   const double AD_dD20 = invdx0*(-2.0/3.0*AD2_i0m1_i1_i2 + (1.0/12.0)*AD2_i0m2_i1_i2 + (2.0/3.0)*AD2_i0p1_i1_i2 - 1.0/12.0*AD2_i0p2_i1_i2);
   const double AD_dD21 = invdx1*(-2.0/3.0*AD2_i0_i1m1_i2 + (1.0/12.0)*AD2_i0_i1m2_i2 + (2.0/3.0)*AD2_i0_i1p1_i2 - 1.0/12.0*AD2_i0_i1p2_i2);
   /* 
