{
   ...
   const double AD_dD01 = invdx1*(-1.0/2.0*AD0_i0_i1m1_i2 + (1.0/2.0)*AD0_i0_i1p1_i2);
   ...
   const double AD_dD21 = invdx1*(-1.0/2.0*AD2_i0_i1m1_i2 + (1.0/2.0)*AD2_i0_i1p1_i2);
   const double AD_ddnD10 = invdx0*((3.0/2.0)*AD1 - 2*AD1_i0m1_i1_i2 + (1.0/2.0)*AD1_i0m2_i1_i2);
   const double AD_ddnD20 = invdx0*((3.0/2.0)*AD2 - 2*AD2_i0m1_i1_i2 + (1.0/2.0)*AD2_i0m2_i1_i2);
   /* 
   ...
   aux_gfs[IDX4(BU1GF, i0, i1, i2)] = AD_dD02*tmp0 - AD_ddnD20*tmp0;
   aux_gfs[IDX4(BU2GF, i0, i1, i2)] = -AD_dD01*tmp0 + AD_ddnD10*tmp0;
}
