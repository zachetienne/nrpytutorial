{
   ...
   const double AD_dupD01 = invdx1*(-3.0/2.0*AD0 + 2*AD0_i0_i1p1_i2 - 1.0/2.0*AD0_i0_i1p2_i2);
   const double AD_dupD21 = invdx1*(-3.0/2.0*AD2 + 2*AD2_i0_i1p1_i2 - 1.0/2.0*AD2_i0_i1p2_i2);
   /* 
   ...
   aux_gfs[IDX4(BU0GF, i0, i1, i2)] = -AD_dD12*tmp0 + AD_dupD21*tmp0;
   aux_gfs[IDX4(BU1GF, i0, i1, i2)] = AD_dD02*tmp0 - AD_dD20*tmp0;
   aux_gfs[IDX4(BU2GF, i0, i1, i2)] = AD_dD10*tmp0 - AD_dupD01*tmp0;
}
