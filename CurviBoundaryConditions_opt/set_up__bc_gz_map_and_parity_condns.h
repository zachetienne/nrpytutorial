...
void eval_symbolic_dot_products_to_set_parity_conditions(REAL parity[10], 
...
#define EPS_ABS 1e-8
    ...
    if(i0_inbounds-i0 == 0 && i1_inbounds-i1 == 0 && i2_inbounds-i2 == 0) {
      ...
      eval_symbolic_dot_products_to_set_parity_conditions(REAL_parity_array,  xx0,xx1,xx2, 
