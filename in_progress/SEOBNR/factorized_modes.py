# The resummed factorized modes for the spinning effective one-body formulation
# See Taracchini et. al. (2012): https://arxiv.org/abs/1202.0790

import numpy as np

#Input variables: will eventually want to read in from another file?
m1 = 10.
m2 = 15.
eta = 0.24000000000000002
chiS = 0.020800681907460566
chiA = -0.05685619431741816
a = 0.01024299840812406
...
rho22v5 = -34.*a/21.
rho22v6 = (1556919113./122245200. + (89.*a2)/252. - (48993925.*eta)/9779616. - (6292061.*eta2)/3259872. + (10620745.*eta3)/39118464. + (41.*eta*np.pi*np.pi)/192.)
rho22v6l = -428./105.
...
rho32v2 = (-4.*a2*eta2)/(9.*np.power(m1 + 3*eta,2)) + (328. - 1115.*eta + 320.*eta2)/(270.*m1p3eta)
rho32v3 = 2./9.*a
rho32v4 = a2/3. + (-1444528. + 8050045.*eta - 4725605.*eta2 - 20338960.*eta3 + 3085640.*eta4)/np.power(1603800.*m1p3eta,2)
rho32v5 = (-2788.*a)/1215.
...
rho44v4 = a2/2. + (-511573572. + 2338945704.*eta - 313857376.*eta2 - 6733146000. * eta3 + 1252563795.*eta4)/(317116800.*np.power(m1p3eta,2))
rho44v5 = (-69.*a)/55.
...
rho42v4 = a2/2. + (-114859044. + 295834536.*eta + 1204388696.*eta2 - 3047981160.*eta3 - 379526805.*eta4)/(317116800.*m1p3eta*m1p3eta)
rho42v5 = (-7.*a)/110.
...
rho75v3 = -2.*a/3.
rho74v2 = (17756. - 131805.*eta + 298872.*eta2 - 217959.*eta3 + 41076.*eta4)/(14994.*(-1. + 7.*eta - 14.*eta2 + 7. * eta3))
rho73v2 = (-666. + 2806.*eta - 2563.*eta2 + 420.*eta3)/(714.*(deltam2 + 3.*eta2))
rho73v3 = -2.*a/3.
rho72v2 = (16832. - 123489.*eta + 273924.*eta2 - 190239.*eta3 + 32760.*eta4)/(14994.*(-1. + 7.*eta - 14.*eta2 + 7.*eta3))
...
rho83v2 = (20598. - 131059.*eta + 249018.*eta2 - 149950.*eta3 + 24520.*eta4)/(18240.*(-1. + 6.*eta - 10.*eta2 + 4.*eta3))
