...
def GiRaFFE_NRPy_P2C(gammadet,gammaDD,betaU,alpha,  ValenciavU,BU, sqrt4pi):
    ...
    smallb4U[0] = 0
    for i in range(3):
        smallb4U[i+1] = BU[i] / (sqrt4pi*alpha*GRHD.u4U_ito_ValenciavU[0])
...
#     GRFFE.compute_smallb4U(gammaDD, betaU, alpha, GRHD.u4U_ito_ValenciavU, BU, sqrt4pi)
    ...
    GRFFE.compute_TEM4UU(gammaDD, betaU, alpha, smallb4U, GRFFE.smallbsquared, GRHD.u4U_ito_ValenciavU)
