...
def test_GiRaFFEfood_HO_Exact_Wald():

    module = 'GiRaFFEfood_HO.GiRaFFEfood_HO_Exact_Wald'

    module_name = 'GiRaFFEfood_HO_Exact_Wald'

    function_and_global_dict = {'GiRaFFEfood_HO_Exact_Wald()': ['AD', 'ValenciavU']}
