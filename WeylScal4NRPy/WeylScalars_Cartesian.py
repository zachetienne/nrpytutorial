...
# The default value here will only output psi4.
par.initialize_param(par.glb_param("bool", thismodule, "output_all_psis", False))
par.initialize_param(par.glb_param("bool", thismodule, "output_invars", False))
...
par.set_parval_from_str("output_all_psis",True)
par.set_parval_from_str("output_invars",True)
#bssn.BSSN_RHSs() 
...
curvJi_rhs = sp.im(psi4 * (psi2*psi0 - psi1*psi1) - \
               psi3 * (psi3*psi0 - psi1*psi2) + \
               psi2 * (psi3*psi1 - psi2*psi2) )
print(("curvIr = "+str(curvIr_rhs)).replace("**","^").replace("_d","d"))#.replace("re","").replace("im",""))
#print(("curvIi = "+str(curvIi)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
#print(("curvJr = "+str(curvJr)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
#print(("curvJi = "+str(curvJi)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
...
#print(("curvJ1 = "+str(curvJ1)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
#print(("curvJ2 = "+str(curvJ2)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
#print(("curvJ3 = "+str(curvJ3)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))
#print(("curvJ4 = "+str(curvJ4)).replace("**","^").replace("_d","d").replace("re","").replace("im",""))