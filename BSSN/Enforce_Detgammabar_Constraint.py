...
def output_Enforce_Detgammabar_Constraint_Ccode():
    ...
    # Step 2: All barred quantities are defined in terms of BSSN rescaled gridfunctions,
    #         which we declare here in case they haven't yet been declared elsewhere.
    Bubv.BSSN_barred_variables()
    gammabarDD = Bubv.gammabarDD

    # Step 3: Set spatial dimension (must be 3 for BSSN, a 3+1 decomposition of Einstein's equations of general relativity)
    DIM = 3
